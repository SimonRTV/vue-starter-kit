...
<template>
    <div class="space-y-6">
        <Heading
            ...
            description="Supprimez votre compte et toutes les données associées"
        />
        <div
                ...
                <DialogContent>
                    ...
                    >
                        <DialogHeader class="space-y-3">
                            ...
                            >
                            <DialogDescription>
                                La suppression de votre compte entraînera la
                                suppression définitive de toutes les données
                                associées. Saisissez votre mot de passe pour
